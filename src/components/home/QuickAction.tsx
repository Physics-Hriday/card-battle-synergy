...
const QuickAction = ({ title, description, icon, color, to }: QuickActionProps) => (
  <Link 
    to={to} 
    className="group relative overflow-hidden rounded-xl bg-white/5 p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl border border-transparent hover:border-white/10"
  >
